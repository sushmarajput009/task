...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_task_post'])) {
    ...
    $form_data = [
        ...
        'assign_to' => isset($_POST['assign_to']) ? $_POST['assign_to'] : [], // Use the submitted checkboxes
    ];

    // Call the add_new_task method
    $obj_admin->add_new_task($form_data);
}
...
<?php 
    ...
    <?php while($row = $info->fetch(PDO::FETCH_ASSOC)){ ?>
        <div class="checkbox">
            <label>
            <input type="checkbox" name='assign_to[]' value="<?php echo $row['user_id']; ?>">
...
<!-- Add this button somewhere in your HTML, e.g., after the "Go Back" button -->
<div class="form-group">
    <div class="col-sm-3">
